...
#     def __init__(self, num_layers, feature_dim, use_pool, use_dropout):
...
#         self.cnn = nn.Sequential(*net_list)
...
def spherenet(num_layers, feature_dim, use_pool, use_dropout):
    ...
    if use_pool:
        ...
        net_list += [nn.Linear(512*8*8, feature_dim)]
    return nn.Sequential(*net_list)
